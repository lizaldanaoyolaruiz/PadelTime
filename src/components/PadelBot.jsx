...
export default function PadelBot() {
  ...
  return (
    <div className="pb-root">
              ...
              <div key={msg.id} className={`pb-row pb-row--${msg.role}`}>
                ...
                >
                  ...
                  {msg.bookingOptions && (
                    <div className="pb-booking">
                      <p className="pb-booking-meta">
                        {msg.bookingOptions.complejo} ·{" "}
                        {msg.bookingOptions.fechaFormateada} ·{" "}
                        {msg.bookingOptions.horario}
                      </p>
                  ...
                  {msg.alternativasOpciones && (
                    <div className="pb-booking">
                      <p className="pb-booking-meta">
                        {msg.alternativasOpciones.complejo} ·{" "}
                        {msg.alternativasOpciones.fechaFormateada} · Horarios
                        disponibles
                      </p>
                      {msg.alternativasOpciones.slots.map((slot) => (
                        <div key={slot.horario} className="pb-slot-group">
                          <p className="pb-slot-label">
                            🕐 {slot.horarioLabel}
                          </p>
      ...
      <button
        className={`pb-fab${open ? " pb-fab--open" : ""}`}
        onClick={() => setOpen((o) => !o)}
      >
