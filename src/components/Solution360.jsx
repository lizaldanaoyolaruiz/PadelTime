  ...
  return (
    <section className="solutions" id="nosotros">
      <div className="solutions-content">
        <h2>
          Soluciones 360° para el{" "}
          <span className="highlight">Ecosistema Pádel</span>
        </h2>
        ...
        <div className="feature-item">
          ...
          <div className="feature-text">
            ...
            <p>
              Reserva tu pista en segundos, encuentra compañeros de tu nivel y
              gestiona tus partidos desde cualquier dispositivo.
            </p>
          </div>
        </div>
        ...
        <div className="feature-item">
          ...
          <div className="feature-text">
            <h3>Para Clubes</h3>
            <p>
              Optimiza la ocupación de tus pistas, automatiza cobros y obtén
        ...
        <div className="solutions-actions">
          ...
          <button className="btn-club" onClick={() => navigate("/register")}>
            SOY UN CLUB
          </button>
        </div>
      </div>
      ...
      <div className="solutions-dashboard tournaments-widget">
              ...
              return (
                ...
                >
                  ...
                  <div className="tournament-info">
                    ...
                    <span className="t-club">
                      {t.complejo?.name || t.ubicacion}
                    </span>
                    {t.categoria && (
        ...
        <button
          className="btn-view-all-tournaments"
          onClick={() => navigate("/torneos")}
        >
