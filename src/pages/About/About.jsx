    ...
    <div className="nosotros-page">
      ...
      <main className="nosotros-main">
        <section className="nos-hero">
          ...
          <h1 className="nos-h1">
            Nuestra misión es{" "}
            <span className="nos-h1-accent">digitalizar el pádel.</span>
          </h1>
          <p className="nos-hero-text">
            Nacimos de la intersección entre la pasión por el deporte y la
            obsesión por la eficiencia tecnológica. En PadelTime, eliminamos las
        ...
        <section className="nos-stats-grid">
          ...
          <div className="nos-card nos-card--vision">
            <h2 className="nos-card-title nos-vision-title">
              Nuestra Visión 2027
            </h2>
            <p className="nos-card-text">
        ...
        <section className="nos-features-grid">
          ...
          <div className="nos-card">
            ...
            <p className="nos-card-text">
              Diseñado para ser veloz. Reservas completadas en menos de 3 clics
