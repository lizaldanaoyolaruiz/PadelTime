...
const DEV_USERS = [
  {
    label: "Admin",
    user: { id: "1", name: "Marcos Padel", role: "admin", isVerified: true },
    token: "dev-admin-token",
  },
  {
    label: "Jugador",
    user: { id: "3", name: "Juan Pérez", role: "player", isVerified: true },
    token: "dev-player-token",
  },
  {
    label: "Super Admin",
    user: {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (
        ...
        msg.toLowerCase().includes("aprobaci")
      ) {
