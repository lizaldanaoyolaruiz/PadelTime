  ...
  const onSubmit = async ({ nombre, apellido, email, password }) => {
    try {
      ...
      if (role === "admin") {
        ...
        await toastSuccess(
          "¡Cuenta creada! Verificá tu email antes de ingresar.",
        );
        navigate("/login");
      }
    } catch (err) {
    ...
    <div className="auth-wrapper">
      <div className="auth-card">
        ...
        >
          <div className="form-row">
            <div className="form-group">
              ...
              <div
                className={`input-wrapper${errors.nombre ? " input-error" : ""}`}
              >
            ...
            <div className="form-group">
              ...
              <div
                className={`input-wrapper${errors.apellido ? " input-error" : ""}`}
              >
                <span className="input-icon">
                  <svg
                    width="18"
        ...
        <p className="auth-legal">
          ...
          <Link to="/terminos">Términos de Servicio</Link> y{" "}
