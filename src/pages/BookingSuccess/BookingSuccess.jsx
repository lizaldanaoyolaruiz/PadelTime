...
export default function BookingSuccess() {
  ...
  useEffect(() => {
    ...
    api
      .patch(`/bookings/${bookingId}/payment-success`, {
        paymentId,
        collectionStatus,
      })
      .then((res) => {
    ...
    <div style={{ textAlign: "center", padding: "80px 20px", color: "#fff" }}>
      ...
      {estado === "ok" && (
        <>
          ...
          <p>
            Tu pago fue procesado correctamente. Te enviamos un email con los
            detalles.
          </p>
          <button
      ...
      {estado === "rechazado" && (
        <>
          ...
          <p>
            Tu pago no fue aprobado. La reserva fue cancelada. Podés intentarlo
            nuevamente.
          </p>
          <button
            onClick={() => navigate(-1)}
      ...
      {estado === "en_proceso" && (
        <>
          <h2 style={{ color: "#fbbf24", marginBottom: 12 }}>
            Pago en proceso
          </h2>
      ...
      {estado === "error" && (
        <>
          ...
          <p style={{ color: "#94a3b8" }}>
            No pudimos confirmar tu reserva. Contactá al complejo.
          </p>
          <button
            onClick={() => navigate("/")}
            style={{
