...
export default function OwnerStats() {
  ...
  const incomeData = m.incomeByType || [
    { name: "Pago Completo", value: 70 },
    { name: "Señas", value: 30 },
  ];
    ...
    <div className="mtr-page">
      ...
      {periodo === "personalizado" && (
        <div className="mtr-custom-range">
          ...
          />
          <button className="mtr-apply-btn" onClick={handleCustomApply}>
            Aplicar
          </button>
        </div>
      )}
            ...
            {(m.rankingCanchas || []).map((c, i) => (
              <div key={c.name} className="mtr-ranking-item">
                <div className="mtr-ranking-row">
                  ...
                  <span className="mtr-ranking-count">
                    {c.reservas} reservas
                  </span>
                </div>
                <div className="mtr-bar-bg">
                  <div
                    ...
                    style={{
                      width: `${Math.round((c.reservas / rankingMax) * 100)}%`,
                    }}
                  />
                </div>
              </div>
      ...
      <div className="mtr-section-card">
        <div className="mtr-section-head">
          <div>
            ...
            <p className="mtr-section-desc">
              Frecuencia de reservas por hora y día
            </p>
          </div>
          ...
          <div className="mtr-analysis-body">
            ...
            <div>
              {m.peakHour ? (
                <>
                  <p>
                    Pico máximo alcanzado: <strong>{m.peakHour.label}</strong>
                  </p>
                  <p>
                    La demanda más alta del período se concentra en ese horario.
                  </p>
                  <p>
                    Recomendación: Revisá tarifas diferenciadas para maximizar
                    ingresos.
                  </p>
                </>
              ) : (
                <p>
                  No hay suficientes datos para analizar horas pico en este
                  período.
                </p>
              )}
            </div>
