...
export default function GeneralPanel({ complexId }) {
  ...
  const cargarDatos = useCallback(async () => {
    try {
      ...
      const pendientes =
        pendientesRes.data.bookings || pendientesRes.data || [];
    ...
    <div className="panel-wrap">
      <div className="pg-header">
        <div>
          ...
          <p className="panel-subtitle" style={{ textTransform: "capitalize" }}>
            {todayLabel}
          </p>
        </div>
        <div className="pg-header-actions">
          <span className="mp-status">
            ...
            Mercado Pago:{" "}
            {complejo?.mercadopagoActive ? "Conectado" : "No conectado"}
          </span>
