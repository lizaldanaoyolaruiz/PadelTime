    ...
    getMyComplex()
      ...
      .catch((err) => {
        ...
        if (status && ![404, 401, 403].includes(status))
          errorAlert("Error cargando el complejo.");
      })
    ...
    try {
      ...
      await successAlert(
        complejo
          ...
          : "Complejo creado — pendiente de aprobación.",
      );
    } catch (err) {
      await errorAlert(
      ...
      <div className="panel-header">
        <div>
          ...
          <p className="panel-subtitle">
            Configurá tu espacio para que los jugadores puedan encontrarte y
            reservar online.
          </p>
        </div>
        {complejo && (
          <span className={`status-badge status-${complejo.status}`}>
            {complejo.status === "pending"
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="form-section">
          ...
          <p className="section-desc">
            Subí hasta 5 fotos. Serán visibles en el portal público de reservas.
          </p>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              {errors.name ? (
                ...
                <span className="form-hint">
                  {watchedName.length}/100 — mín. 3 caracteres
                </span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.openTime && (
                <span className="error-msg">{errors.openTime.message}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.closeTime && (
                <span className="error-msg">{errors.closeTime.message}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              {errors.depositPercentage ? (
                ...
                <span className="form-hint">
                  Entero entre 0 y 100 (0 = sin seña)
                </span>
              )}
            </div>
            ...
            <div className="form-group form-group--full">
              ...
              {errors.description ? (
                ...
                <span className="form-hint">
                  {watchedDescription.length}/500 — mín. 3 caracteres
                </span>
              )}
            </div>
          </div>
        ...
        {!complejo && (
          <div className="info-notice">
            Al crear el complejo quedará en estado{" "}
            <strong>pendiente de aprobación</strong> hasta que el equipo de
            PadelTime lo active.
          </div>
        )}
