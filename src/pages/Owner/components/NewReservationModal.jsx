  ...
  return (
    ...
    >
      <div className="modal-box modal-box--wide">
        ...
        {modo === "reserva" && (
          <form
            onSubmit={handleSubmit(onSubmitReserva)}
            noValidate
          ...
          >
            ...
            {slotData ? (
              <div className="form-group">
                ...
                <div
                  ...
                  style={{ color: "var(--color-text-base)", cursor: "default" }}
                >
            ...
            >
              <div className="form-group">
                ...
                {errors.jugadorNombre ? (
                  <span className="error-msg">
                    {errors.jugadorNombre.message}
                  </span>
                ) : (
                  <span className="form-hint">
                    {watchedNombre.length}/50 — solo letras, mín. 3
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errors.jugadorApellido ? (
                  <span className="error-msg">
                    {errors.jugadorApellido.message}
                  </span>
                ) : (
                  <span className="form-hint">
                    {watchedApellido.length}/50 — solo letras, mín. 3
                  </span>
                )}
              </div>
            </div>
            ...
            >
              ...
              <div className="form-group">
                ...
                {errors.jugadorTelefono ? (
                  <span className="error-msg">
                    {errors.jugadorTelefono.message}
                  </span>
                ) : (
                  <span className="form-hint">
            ...
            <div className="form-group">
              ...
              {errors.observaciones ? (
                ...
                <span className="form-hint">
                  {watchedObs.length}/200 — mín. 3 caracteres
                </span>
              )}
            </div>
        ...
        {modo === "mantenimiento" && (
          <form
            onSubmit={onSubmitMantenimiento}
            noValidate
            className="modal-form"
          >
