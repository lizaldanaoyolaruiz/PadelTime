        ...
        <form onSubmit={handleSubmit(onSave)} noValidate className="modal-form">
          <div className="form-group">
            ...
            {errors.nombre ? (
              ...
              <span className="form-hint">
                {watchedNombre.length}/100 — mín. 3 caracteres
              </span>
            )}
          </div>
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              />
              {errors.fechaInicio && (
                <span className="error-msg">{errors.fechaInicio.message}</span>
              )}
            </div>
            <div className="form-group">
              ...
              />
              {errors.fechaFin && (
                <span className="error-msg">{errors.fechaFin.message}</span>
              )}
            </div>
          </div>
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              />
              {errors.ubicacion && (
                <span className="error-msg">{errors.ubicacion.message}</span>
              )}
            </div>
            <div className="form-group">
              ...
              />
              {errors.cupoMaximo && (
                <span className="error-msg">{errors.cupoMaximo.message}</span>
              )}
            </div>
          </div>
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              {errors.categoria && (
                <span className="error-msg">{errors.categoria.message}</span>
              )}
            </div>
            <div className="form-group">
              ...
              {errors.estado && (
                <span className="error-msg">{errors.estado.message}</span>
              )}
            </div>
          </div>
