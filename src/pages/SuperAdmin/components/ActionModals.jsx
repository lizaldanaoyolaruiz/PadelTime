          ...
          <div className="gc-new-modal-title-row">
            ...
            <div>
              ...
              <p className="gc-new-modal-subtitle">
                Modificá los datos del complejo.
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div className="gc-new-field gc-new-field--full">
            ...
            {errors.address ? (
              ...
              <span className="gc-new-hint">
                {watchedAddress.length}/120 — mín. 5 caracteres
              </span>
            )}
          </div>
      ...
      <div className="gc-modal">
        ...
        {type === "reject" && (
          <>
            ...
            <p className="gc-modal-text">
              Vas a rechazar <strong>{complex.name}</strong>. Puedes incluir el
        ...
        {type === "suspend" && (
          <>
            ...
            <p className="gc-modal-text">
              Este complejo dejará de visualizarse en el portal{" "}
              <strong>inmediatamente</strong>. ¿Confirmas la suspensión de{" "}
            ...
            <div className="gc-modal-actions">
              ...
              <button
                className="gc-modal-btn gc-modal-btn--suspend"
