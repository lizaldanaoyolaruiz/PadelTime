...
export function NewComplexModal({ onClose, onCreated }) {
  ...
  return (
    <div className="gc-modal-overlay" role="dialog" aria-modal="true" aria-label="Nuevo complejo">
        ...
        <div className="gc-new-modal-header">
          <div className="gc-new-modal-title-row">
            ...
            <div>
              ...
              <p className="gc-new-modal-subtitle">Completá los datos para registrar el complejo.</p>
            </div>
          </div>
