...
export const getSlotsCalendar  = (params)       => api.get('/bookings/slots', { params });
export const getSlotsPublicos  = (params)       => api.get('/bookings/slots', { params: { ...params, vista: 'publica' } });
...
export const getMantenimientos     = (params)   => api.get('/maintenance', { params });
